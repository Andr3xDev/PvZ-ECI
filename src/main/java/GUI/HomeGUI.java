...
public final class HomeGUI extends JPanel {
    ...
    private void prepareElements() {
        ...
        // Background Elements
        BackgroundImage backgroundImage = new BackgroundImage("src/main/resources/background/backHome.png");
        new BackgroundSound("src/main/resources/sound/LoonBoon.wav");
